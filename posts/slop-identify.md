...
It turns out that there is significant overlap between some of the best quality output that AI can come up with and the worst quality output of humans. Algorithmically, there's no way to classify it one way or the other with certainty.
